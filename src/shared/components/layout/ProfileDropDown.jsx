    ...
    return (
        <Popover className={"md:mr-11 mr-4"}>
            ...
            <PopoverPanel
                transition
                anchor="bottom"
                className="divide-y divide-gray-200 border dark:bg-black dark:border-gray-600 border-gray-100 bg-gray-50 text-sm/6
            ...
            >
                <div className="p-1 gap-2 space-y-1">
                    ...
                    <button 
                        className="flex px-3 py-1 transition w-full dark:hover:bg-gray-800 hover:bg-gray-200"
                        onClick={() => {
                            navigate("/dashboard/profile")
                        }}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mr-1 text-gray-600 dark:text-white">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        </svg>
                        <p className="text-gray-900 text-start dark:text-white">Perfil</p>
                    </button>
                    <button 
                        className="flex px-3 py-1 transition w-full hover:bg-gray-200 dark:hover:bg-gray-800"
                        onClick={() => {
                    ...
                    >
                        ...
                        <p className="text-gray-900 text-start dark:text-white">Configuración</p>
                    </button>
