  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-4 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col pb-2 space-y-2 border dark:border-gray-600 border-gray-200 p-5">
          <div className="flex justify-between">
            <h2 className="font-medium dark:text-white">Saldo Total</h2>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 text-gray-500 dark:text-gray-300">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
            </svg>
          </div>
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold dark:text-gray-200">$45231.89</p>
            <button
              onClick={() => setIsOpen(true)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 hover:cursor-pointer hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-gray-800 p-1">
        ...
        <div className="flex flex-col pb-2 space-y-2 border dark:border-gray-600 border-gray-200 p-5">
          <div className="flex justify-between">
            <h2 className="font-medium dark:text-white">Ingresos</h2>
          ...
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold dark:text-gray-300">$7,350.50</p>
          </div>
          <p className="text-xs text-gray-500">+12.5% desde el mes pasado</p>
        </div>

        <div className="rouded-lg flex flex-col pb-2 dark:border-gray-600 space-y-2 border border-gray-200 p-5">
          <div className="flex justify-between">
            <h2 className="font-medium dark:text-white">Gastos</h2>
          ...
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold dark:text-gray-300">$4,120.00</p>
          </div>
        ...
        <div className="rouded-lg flex flex-col pb-2 dark:border-gray-600 space-y-2 border border-gray-200 p-5">
          <div className="flex justify-between">
            <h2 className="font-medium dark:text-white">Ahorro</h2>
          ...
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold dark:text-gray-300">$3,200.00</p>
          </div>
